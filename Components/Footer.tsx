...
const Footer = ({
  ...
  return (
    <div className={`footer__container ${extraClasses}`}>
      ...
      <p className="smaller__text" style={{color: "#0057a4", marginTop: "8px", maxWidth: "90%", marginLeft: "auto", marginRight: "auto"}}>Lättenstrasse&nbsp;&nbsp;37,&nbsp;&nbsp;8952&nbsp;&nbsp;Schlieren</p>
      <Link href="mailto:info@gruezh.ch" style={{textDecoration: "none"}}>
        <p className="smaller__text" style={{color: "#0057a4", marginTop: "8px", maxWidth: "90%", marginLeft: "auto", marginRight: "auto"}}>info@gruezh.ch</p>
      </Link>
      <Link href="tel:+41 44 521 14 14" style={{textDecoration: "none"}}>
        <p className="smaller__text" style={{color: "#0057a4", marginTop: "8px", maxWidth: "90%", marginLeft: "auto", marginRight: "auto"}}>+41 44 521 14 14</p>
      </Link>
      <p className="smaller__text" style={{color: "#0057a4", marginTop: "8px", maxWidth: "90%", marginLeft: "auto", marginRight: "auto", marginBottom: "66px"}}>ALL RIGHTS RESERVED 2024 GRUEZH AG</p>
    </div>
  )
}
